...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("C:\\Users\\xq\\Desktop\\yeb\\back\\yebProject\\yeb-server" + "/src/main/java");
        gc.setAuthor("xq");
        ...
        dsc.setUrl("jdbc:mysql://192.168.127.22:3307/yeb?serverTimezone=GMT%2B8");
        ...
        // 5、策略配置 ,"acl_user_role","acl_user"
        StrategyConfig strategy = new StrategyConfig();
        strategy.setInclude("t_salary"); //多张表用逗号隔开
